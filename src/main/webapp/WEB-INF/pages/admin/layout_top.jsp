...
<html>
    <head>
        ...
        <link href="<spring:url value="/resources/css/admin/jquery.steps.css" />" rel="stylesheet" />
        <link href="<spring:url value="/resources/css/admin/js-tree/style.min.css" />" rel="stylesheet" />
        <link href="<spring:url value="/resources/css/admin/choosen/chosen.css" />" rel="stylesheet" />
        ...
        <script src="<spring:url value="/resources/js/admin/chosen.jquery.js"/>"></script>
