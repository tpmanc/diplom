...
## Дела
 ...
 54. Добавить в БД для заявки поле комментарий и заполнять его при отконении или принятии
 55. Переделать логи на syslog
 56. Добавить настроку пути для сохранения файлов и файлов заявок
 57. Обработка заявок модератором
 58. Сделать проверку при логине: если properties не заполнены, то перенаправлять на страницу заполнения
 59. При отклонении заявки удалять файл?