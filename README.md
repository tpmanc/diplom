...
## Дела
 ...
 56. Добавить в БД для заявки поле комментарий и заполнять его при отконении или принятии
 57. Обработка заявок модератором
 58. Переделать логи на syslog
 59. Добавить кнопку удалить заявку (удалять из БД и файлы)