...
## Дела
 ...
 28. Возможность просмотра логов по уровням, удаления логов
 29. Получение роли из AD
 30. Сделать чтобы админ видел все незаполненные файлы
 31. Вынести настройки БД и, наверно, Active Directory в отдельный файл `.properties`
 ...
 44. Сделать нормаьлныу страницу ошибки